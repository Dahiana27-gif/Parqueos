...
<html lang="en">
 ...
 <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.3/font/bootstrap-icons.css">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          ...
          <i class="fas fa-id-card"></i>Chat Online</a>
  ...
  <div class="wrapper fixed-left">
    <nav id="sidebar">
      ...
      <ul class="list-unstyled components">
        ...
        <li>
          <a href=""><i class="fas fa-clipboard"></i>Usuarios</a>
        </li>
        <li>
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <!---Formulario de Registro de usuario Nuevo--->
                                                                      ...
                                                                      <div class="form-row">
                                                                        <div class="col-md-6 mb-3">
                                                                          <label for="validationTooltip03">Contrasena</label>
                                                                          <input type="text" class="form-control" id="validationTooltip03" required>
                                                                          <div class="invalid-tooltip">
                                                                            Agregar contrasena Segura.
                                                                          </div>
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                          <label for="validationTooltip04">Vehiculo</label>
                                                                          <select class="custom-select" id="validationTooltip04" required>
                                                                            <option selected disabled value="">Tipo de vehiculo</option>
                                                                            <option>Motor</option>
  ...
  <a class="navbar-brand">Registros de Usuarios</a>
  <form class="form-inline">
    <input class="form-control mr-sm-2" type="search" placeholder="Buscuar Usuarios" aria-label="Search">
